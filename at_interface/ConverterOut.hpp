...
class ConverterOut : public AnalysisTree::Task {
 ...
 protected:
  ...
  int chi2prim_first_vec_field_id_{-1};
  int chi2prim_first_cov_field_id_{-1};
  int chi2prim_second_vec2_field_id_{-1};
  int chi2prim_second_det_field_id_{-1};
  int chi2prim_second_detinv_field_id_{-1};
  int chi2prim_second_vec_field_id_{-1};
  int chi2prim_second_cov_field_id_{-1};
  ...
  int chi2geo_vec_field_id_{-1};
  int chi2geo_cov_field_id_{-1};
